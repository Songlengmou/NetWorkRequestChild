@file:Suppress(
    "UNCHECKED_CAST", "unused", "NON_PUBLIC_CALL_FROM_PUBLIC_INLINE", "SpellCheckingInspection"
)
...
object ActivityMessenger {
     ...
     */
    fun startActivity(
        starter: FragmentActivity, target: KClass<out Activity>, vararg params: Pair<String, Any>
