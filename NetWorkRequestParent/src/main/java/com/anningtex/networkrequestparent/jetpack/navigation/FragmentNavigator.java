...
public class FragmentNavigator extends Navigator<FragmentNavigator.Destination> {
    ...
    @Deprecated
    @NonNull
    public Fragment instantiateFragment(@NonNull Context context, @NonNull FragmentManager fragmentManager, @NonNull String className, @SuppressWarnings("unused") @Nullable Bundle args) {
    ...
    public static class Destination extends NavDestination {
        ...
        public void onInflate(@NonNull Context context, @NonNull AttributeSet attrs) {
            ...
            TypedArray a = context.getResources().obtainAttributes(attrs, androidx.navigation.fragment.R.styleable.FragmentNavigator);
