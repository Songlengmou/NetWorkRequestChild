package com.anningtex.networkrequestparent.jetpack.navigation;
...
public final class DialogFragmentNavigator extends Navigator<DialogFragmentNavigator.Destination> {
    ...
    public boolean popBackStack() {
        ...
        Fragment existingFragment = mFragmentManager.findFragmentByTag(DIALOG_TAG + --mDialogCount);
    ...
    @Nullable
    @Override
    public NavDestination navigate(@NonNull final Destination destination, @Nullable Bundle args, @Nullable NavOptions navOptions, @Nullable Extras navigatorExtras) {
        if (mFragmentManager.isStateSaved()) {
    ...
    public void onRestoreState(@Nullable Bundle savedState) {
        if (savedState != null) {
            ...
            for (int index = 0; index < mDialogCount; index++) {
                DialogFragment fragment = (DialogFragment) mFragmentManager.findFragmentByTag(DIALOG_TAG + index);
                if (fragment != null) {
    ...
    public static class Destination extends NavDestination implements FloatingWindow {
        ...
        public void onInflate(@NonNull Context context, @NonNull AttributeSet attrs) {
            ...
            TypedArray a = context.getResources().obtainAttributes(attrs, androidx.navigation.fragment.R.styleable.DialogFragmentNavigator);
